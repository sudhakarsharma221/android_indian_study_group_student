...
import com.indianstudygroup.databinding.FragmentGymBookingSeatSelectionBinding


class GymBookingSeatSelectionFragment : Fragment() {
    private lateinit var binding: FragmentGymBookingSeatSelectionBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentGymBookingSeatSelectionBinding.inflate(layoutInflater)
    ...
    private fun intiListener() {
        ...
        binding.moreBill.setOnClickListener {
            if (selectedPosition < 0) {
                ...
                findNavController().navigate(R.id.action_gymBookingSeatSelectionFragment_to_gymBookingOrderSummaryFragment,
                    Bundle().apply {
