...
import com.indianstudygroup.databinding.ActivityGymScannerBinding
...
class GymScannerActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGymScannerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGymScannerBinding.inflate(layoutInflater)
